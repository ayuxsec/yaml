...
import (
	...
	"github.com/ayuxsec/yaml" // go get github.com/ayuxsec/yaml
)

func main() {
	type person struct {
		Name string `yaml:"name" yaml_line_comment:"your name here"`
	}
	...
	fmt.Print(string(data)) // name: spike # your name here
}
```
